...
```text
Brainstorm 100 novel SMR/consensus protocol candidates across different design dimensions. For each idea, briefly state its core mechanism, expected advantage, main risk, and closest related protocols.
```
