...
| [[EPaxosStar|EPaxos*]] | Validated leaderless dependency order | Simplifies/fixes EPaxos recovery with `bal`/`abal` and validation | Optimal `f`-resilient `e`-fast bound | Recovery still has subtle validation cases | [[Making-Democracy-Work-2025]] |
